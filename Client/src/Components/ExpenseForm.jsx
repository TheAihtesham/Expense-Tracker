    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="btn w-full sm:w-[95%]">
                <button type='submit' className='border-2 border-sky-100 border-solid m-[7px] px-[20px] py-[5px] rounded-xl w-full hover:bg-sky-200 hover:text-white hover:font-bold'>Add Expense</button> 
            </div>
        </form>
    );
};
