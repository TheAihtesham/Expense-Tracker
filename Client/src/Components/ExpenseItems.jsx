...
import { bitcoin, calender, cart, commentIcon, deleteIcon, food, health, money, piggy, rupee, school, stocks, youTube } from '../Utils/Icons'
...
const ExpenseItems = ({
  ...
  return (
    <div className=' rounded-xl p-4 mb-4 flex items-center gap-[.7rem] w-full shadow-sky-200 shadow-md '>
      <div className="icons w-30 h-30 flex items-center rounded-[24px] justify-center text-3xl pr-2 text-blue-950">
        {type === 'expense' ? expenseIcons() : incomeIcons()}
      </div>
